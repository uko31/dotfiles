...
globalkeys = awful.util.table.join(
    ...
    awful.key(
      ...
      function()
        naughty.notify(
          {
          title    = "Mount USB drives",
          text     = awful.util.pread( mt_usbdrives_cmd ),
          timeout  = 4,
    ...
    awful.key(
      ...
      function()
        awful.util.spawn_with_shell(
          "scrot " .. os.getenv("HOME") .. 
            "/pictures/screenshots/screen-$(date +\"%Y%d%m%H%M%S\").png" )
      end
    ), 
...
-- ajout de la gestion de la transparence sur les fenêtres n'ayant pas le focus
